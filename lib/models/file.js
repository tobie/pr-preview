...
class File {
    constructor(pr, specBuild, filename) {
        this._pr = pr;
        this._specBuild = specBuild;
    ...
    get head() {
        return this._head = this._head || Head.fromPR(this.pr, this.specBuild, this.filename);
    }
    
    get merge_base() {
        return this._merge_base = this._merge_base || MergeBase.fromPR(this.pr, this.specBuild, this.filename);
    }

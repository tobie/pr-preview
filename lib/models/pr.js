...
class PR {
    ...
    get head() {
        return this._head = this._head || new Head(this.payload.head, this);
    }
    
    get base() {
        return this._base = this._base || new Base(this.payload.base, this);
    }
    ...
    requestMergeBase() {
        return this.request(GH_API.GET_COMPARE_COMMITS, {
            ...
            this.merge_base = new MergeBase(payload.merge_base_commit.sha, this.payload.base, this);

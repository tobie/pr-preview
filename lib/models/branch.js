...
class Branch {
    ...
    get github_url() {
        return `https://raw.githubusercontent.com/${ this.owner }/${ this.repo }/${ this.sha }/${ this.pr.config.src_file}`;
    }
    
    get rawgit_url() {
        return `https://cdn.rawgit.com/${ this.owner }/${ this.repo }/${ this.sha }/${ this.pr.config.src_file}`;
    }

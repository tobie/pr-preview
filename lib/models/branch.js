...
class MutableCacheBranch extends Branch {
    ...
    cache() {
        return cache.mutable(this.key, this.getUrl(), postProcessor(this.pr.postProcessingConfig));
    }
}
...
class ImmutableCacheBranch extends Branch {
    ...
    cache() {
        return cache.immutable(this.key, this.getUrl(), postProcessor(this.pr.postProcessingConfig));
    }
}

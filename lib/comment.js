...
module.exports = (payload) => {
    ...
    return gh.request("GET /repos/:owner/:repo/pulls/:number/commits", { number: num }).then(commits => {
        return gh.request("GET /repos/:owner/:repo/pulls/:number/files", { number: num }).then(files => {
